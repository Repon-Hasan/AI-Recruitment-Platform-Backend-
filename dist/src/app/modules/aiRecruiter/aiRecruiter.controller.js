...
import { AIRecruiterService } from "./aiRecruiter.service.js";
    ...
    async assistant(req, res) {
        try {
            ...
            */
            ...
            const result = await AIRecruiterService.assistant(recruiterId, {
                jobId,
                query,
                limit,
            });
...
//# sourceMappingURL=aiRecruiter.controller.js.map