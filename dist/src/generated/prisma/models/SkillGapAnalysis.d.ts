...
export type GetSkillGapAnalysisAggregateType<T extends SkillGapAnalysisAggregateArgs> = {
    [P in keyof T & keyof AggregateSkillGapAnalysis]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateSkillGapAnalysis[P]> : Prisma.GetScalarType<T[P], AggregateSkillGapAnalysis[P]>;
};
...
export type GetSkillGapAnalysisGroupByPayload<T extends SkillGapAnalysisGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<SkillGapAnalysisGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof SkillGapAnalysisGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], SkillGapAnalysisGroupByOutputType[P]> : Prisma.GetScalarType<T[P], SkillGapAnalysisGroupByOutputType[P]>;
}>>;
...
export type SkillGapAnalysisCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<SkillGapAnalysisFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface SkillGapAnalysisDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['SkillGapAnalysis'];
        meta: {
            name: 'SkillGapAnalysis';
        };
    };
     ...
     * })
    **/
    count<T extends SkillGapAnalysisCountArgs>(args?: Prisma.Subset<T, SkillGapAnalysisCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], SkillGapAnalysisCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends SkillGapAnalysisGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, SkillGapAnalysisGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetSkillGapAnalysisGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
//# sourceMappingURL=SkillGapAnalysis.d.ts.map