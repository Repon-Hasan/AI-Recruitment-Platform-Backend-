...
export const getJobApplicationsController = async (
  ...
  const result =
    await getJobApplicationsForRecruiter(
      userId,
      jobId
    );
...
export const getRecruiterApplicationControllerById =
  async (
    req: Request,
    res: Response
  ) => {
  ...
  export const deleteRecruiterApplicationController =
  async (
    req: Request,
    res: Response
  ) => {
  ...
  export const getCompanyApplicationsController =
  async (
    req: Request,
    res: Response
  ) => {
    ...
    const result =
      await getCompanyApplications(userId);
